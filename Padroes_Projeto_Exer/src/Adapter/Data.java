...
public class Data {
	...
	public void setDia(int dia) {
		if (dia >= 1 && dia <= 31) {
			...
			throw new DataInvalidaException("Erro na data escolhida! Dia " + dia + " é inválido.");
		}
	}
		...
		if (mes >= 1 && mes <= 12) {
			...
			case 12:
				if (this.dia <= 31) {
					...
					throw new DataInvalidaException("Erro na data escolhida! Mês " + mes + " é inválido.");
				}
				break;
			case 04:
			case 6:
	...
	public void setAno(int ano) {
		if (ano >= 1900 && ano <= this.anohoje) {
			...
			throw new DataInvalidaException("Erro na data escolhida! Ano " + ano + " é inválido.");
		}
	}
